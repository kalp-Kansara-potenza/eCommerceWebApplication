...
namespace eCommerceWebApplication.Migrations
{
    ...
    [Migration("20210226051309_specificationsXcategory")]
    partial class specificationsXcategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.AppData.DBspecificationsXcategory", b =>
                {
                    b.Property<int>("specificationsXcategory_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("DBspecificationtypespecificationtype_Id")
                        .HasColumnType("int");
                    ...
                    b.HasKey("specificationsXcategory_id");

                    b.HasIndex("DBspecificationtypespecificationtype_Id");

                    b.HasIndex("category_id");

                    b.HasIndex("featuretype_id");

                    b.ToTable("specificationsXcategory");
                });
            ...
            modelBuilder.Entity("Ecommerce.AppData.DBspecificationsXcategory", b =>
                {
                    b.HasOne("Ecommerce.AppData.DBspecificationtype", "DBspecificationtype")
                        .WithMany()
                        .HasForeignKey("DBspecificationtypespecificationtype_Id");
