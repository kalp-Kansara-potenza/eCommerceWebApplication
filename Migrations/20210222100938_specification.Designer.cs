...
namespace eCommerceWebApplication.Migrations
{
    ...
    [Migration("20210222100938_specification")]
            ...
            modelBuilder.Entity("Ecommerce.AppData.Context.DBspecification", b =>
                {
                    ...
                    b.Property<int?>("DBfeaturetypefeaturetype_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DBfeaturetypefeaturetype_id");
            ...
            modelBuilder.Entity("Ecommerce.AppData.Context.DBspecification", b =>
                {
                    b.HasOne("Ecommerce.AppData.DBfeaturetype", "DBfeaturetype")
                        .WithMany()
                        .HasForeignKey("DBfeaturetypefeaturetype_id");
